                   ...
                   <div class="card">
                      ...
                      <div class="card-body">
                            ...
                            <div class="form-floating mb-3">
                              <input type="text" name="fname" class="form-control" id="floatingInputFname" placeholder="first name" autocomplete="none">
                              <label for="floatingInputFname">FIRST NAME</label>
                            </div>                        
                            <div class="form-floating mb-3">
                              <input type="text" name="lname" class="form-control" id="floatingInputLname" placeholder="last name" autocomplete="none">
                              <label for="floatingInputLname">LAST NAME</label>
                            </div>
                            <div class="form-floating mb-3">
                              <input type="email" name="email" class="form-control" id="floatingInputEmail" placeholder="email" autocomplete="none">
                              <label for="floatingInputEmail">EMAIL ID</label>
                            </div>
                            <div class="form-floating mb-3">
                              <input type="number" name="phone" class="form-control" id="floatingInputPhone" placeholder="phone">
                              <label for="floatingInputPhone">PHONE</label>
                            </div>
                            <div class="mb-3">
                              <label for="floatingInputTags" class="ps-2">&nbsp;SKILLS</label><br>
                              <input type="text" name="skills" class="form-control" value="" placeholder="" data-role="tagsinput">
                            </div>


                      </div>
                      <div class="card-footer text-end">
                          <button type="button" id="btnReg" onclick="user_reg()" class="btn btn-primary">REGISTER NOW</button>
                      </div>
                   </div>
                 </form>
...
<div class="modal fade" id="errorModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <script>
        ...
        function user_reg(){
              $('#btnReg').html('<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span> REGISTERING...');
              $('#btnReg').attr('disabled',true); 
              var url;
              var formulario = new FormData($('#userRegForm').get(0));      
              url = "<?php echo base_url('main/home/register')?>"; 
              $.ajax({
                  url : url,
                  type: "POST",
                  data: formulario,
